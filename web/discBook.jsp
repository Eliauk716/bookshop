...
<div id="nav_box">
    <div class="nav_content">
        ...
        <ul class="nav">
            ...
            <li class="nav_active"><a href="discBook.jsp" class="white active">特价专区</a></li>
            ...
            <div class="listRight">
                <ul class="list">
                    <script type="text/javascript">
                        ...
                        var names = ["平原上的摩西", "四个春天", "步履不停", "书店日记", "想象一朵未来的玫瑰", "给作家标个价", "外面是夏天", "你想活出怎样的人生", "被讨厌的勇气",
                            "你当像鸟飞往你的山"
                        ];
                        var authors = ["双雪涛", "陆庆屹", "[日]是枝裕和", "[英]肖恩·白塞尔", "[葡]费尔南多·佩索阿", "[日]出久根达郎","[韩]金爱烂",
                            "[日]吉野源三郎", "[日]岸见一郎","[美]塔拉·韦斯特弗"
                        ];
                        var prices = ["42.30", "36.29", "49.00", "29.99", "79.00", "58.00", "36.00", "58.00", "39.00",
                            "59.00"
                        ];
                        for (var i = 0; i < images.length; i++) {
                            var info = "<li><div class='imgList'><a href='details.html?img=disc/" +
                                images[i] + "&tit=" + names[i] + "&aut=" + authors[i] + "&pri=" + prices[i] +
                                "'><img src='image/disc/" + images[i] +
                                "'></a></div><div class='info'><div class='name'><a href='details.html?img=disc/" +
                                images[i] + "&tit=" + names[i] + "&aut=" + authors[i] + "&pri=" + prices[i] +
